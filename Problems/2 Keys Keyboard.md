...
### Comment
이 문제를 풀면서 숫자를 하나씩 해보며 결과값은 소인수분해한 후 인자들을 모두 더한 값과 같다는 것을 발견했습니다.
하지만 전수조사가 아닌 10개 정도의 예시를 통해 찾아낸 것이며 정확히 증명하지 못하였습니다.
따라서 증명을 하게 된다면 문제를 명확히 이해하고 풀었다고 할 수 있을 것 같습니다.
